  ...
  Widget sliderBarLayout(context, BoxConstraints constraints) {
    ...
    return Flex(
      ...
      children: [
        ...
        Text('Select radius', style: TextStyle(fontSize:10, fontWeight: FontWeight.w400,)),
  ...
  Widget sliderBar() {
    return AnimatedContainer(
        ...
        decoration: BoxDecoration(
            ...
            color: widget.sliderColor ?? Colors.blue,
           ),
        ...
        child: Flex(direction: Axis.vertical, mainAxisAlignment: MainAxisAlignment.end, children: [
          Expanded(
            ...
            Positioned.fill(
                bottom: 0,
                child: Padding(
                  padding: EdgeInsets.only(left: 5, right: 5, bottom: 0, top: 36), 
                  child: sliderBar())),
            AnimatedPositioned(
                ...
                left: indicatorLeft,
                child: Padding(
                  padding: EdgeInsets.only(left: 8, right: 8), child: sliderIndicator()
                  )
                  )
          ]))
        ]));
