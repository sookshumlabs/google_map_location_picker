...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(dynamic _) => <String, Function>{
        "access_to_location_denied":
            MessageLookupByLibrary.simpleMessage("تم رفض إذن الوصل الي الموقع الجغرافي"),
        "access_to_location_permanently_denied":
            MessageLookupByLibrary.simpleMessage("تم رفض إذن الوصل الي الموقع الجغرافي بشكل نهائي"),
        "allow_access_to_the_location_services":
            MessageLookupByLibrary.simpleMessage("من فضلك قم بقبول إذن الوصول الي الموقع الجغرافي"),
        "allow_access_to_the_location_services_from_settings": MessageLookupByLibrary.simpleMessage(
            "من فضلك قم بقبول إذن الوصول الي الموقع الجغرافي من إدادات التطبيق."),
        "cant_get_current_location":
            MessageLookupByLibrary.simpleMessage("لا يمكن الحصول علي الموقع الجغرافي الحالي"),
        ...
        "please_make_sure_you_enable_gps_and_try_again": MessageLookupByLibrary.simpleMessage(
